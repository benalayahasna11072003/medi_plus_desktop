...
public class MailAvisService {
    ...
    public static void sendAvisEmail(String doctorEmail, String doctorName,
                                     String patientName, int note, String commentaire) throws MessagingException, IOException {
        ...
        message.addRecipient(Message.RecipientType.TO, new InternetAddress(doctorEmail));
        message.setSubject("Nouvelle Avis de " + patientName);
        ...
        String htmlContent = "<!DOCTYPE html>"
                ...
                + ".avis-details { margin: 20px 0; padding-left: 20px; border-left: 3px solid #0066CC; }"
                ...
                + "<div class='container'>"
                + "<div class='header'>"
                + "<p>Bonjour <strong>" + doctorName + "</strong>,</p>"
                + "</div>"
                + "<p>Un nouveau avis a été soumis par le patient: <strong>" + patientName + "</strong>.</p>"
                ...
                + "</div>"
                + "<p>Pour toute question, n'hésitez pas à contacter votre équipe médicale.</p>"
                + "<div class='footer'>"
                + "<p>Cordialement,</p>"
        ...
        System.out.println("Avis email sent successfully to: " + doctorEmail);
    }
}